...
async function main() {
  console.log("Charm — Performance Benchmarks");
  console.log("======================================\n");
  console.log("System:");
...
print(f"filtered: {len(filtered)}")
  ...
  // === Comparison Note ===
  console.log("\n=== Comparison: charm vs raw cat/bash ===");
  console.log(
    "When Claude Code uses cat/head/Read to view a 50KB file, ALL 50KB enters context.",
  );
  console.log(
    "With charm execute_file, only the summary (typically 100-500 bytes) enters context.",
  );
