...
const PERSONAS = [
  ...
  },
  {
    ...
    insights: [
      ...
      "New hire ramp: 6 weeks to 2 weeks with charm",
    ],
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h2 className="text-xl font-bold">charm for Enterprise</h2>
      ...
      <Card className="border-blue-500/30 bg-blue-500/5">
        <CardContent className="pt-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <a
              href="mailto:kal@lovablia.com?subject=charm%20Enterprise%20—%20Design%20Partner"
